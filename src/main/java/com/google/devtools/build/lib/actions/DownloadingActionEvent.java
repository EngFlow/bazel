...
public class DownloadingActionEvent implements ProgressLike, ActionStateChangeEvent {
  private final ActionExecutionMetadata action;
  private final String strategy;

  public DownloadingActionEvent(ActionExecutionMetadata action, String strategy) {
    this.action = action;
