...
final class DirectoryTree {
  ...
  static class FileNode extends Node {
    ...
    static FileNode createExecutable(String pathSegment, Path path, Digest digest, boolean toolInput) {
      return new FileNode(pathSegment, path, digest, /* isExecutable= */ true, toolInput);
    }

    static FileNode createExecutable(String pathSegment, ByteString data, Digest digest, boolean toolInput) {
